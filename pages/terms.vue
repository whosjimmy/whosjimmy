	...
	<div class="max-w-4xl mx-auto py-12 px-6 text-gray-800 leading-relaxed">
		...
		<section class="mb-8">
			...
			<p>
				...
				account. We use Google OAuth for authentication; we never see or
		...
		<section class="mb-8">
			...
			<p>
				The application is provided "as is." Johnston Software
				Development shall not be liable for any damages resulting from
